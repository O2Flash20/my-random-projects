class Particle {
    ...
    look(walls) {
        ...
        for (let i = 0; i < this.rays.length; i++) {
            ...
            // get the texture strip from tx
            // let textureCol = null
            // if (hitWall) {
            //     textureCol = closestWall.getTextureColumn(closestsTX)
            // }
            // scene[i] = [record, textureCol]

            if (closestWall) {
                // console.log([record, [closestsTX, closestWall.texture]])
